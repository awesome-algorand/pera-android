...
import co.algorand.app.R
import co.algorand.app.databinding.ActivityGetPasskeyBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (request != null) {
            lifecycleScope.launch {
                val result = viewModel.processGetPasskey(
                    this@GetPasskeyActivity,
                    request,
                    intent.getBundleExtra("CREDENTIAL_DATA")
                )
