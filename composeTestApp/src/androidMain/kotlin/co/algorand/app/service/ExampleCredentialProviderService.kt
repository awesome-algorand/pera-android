package co.algorand.app.service
...
import co.algorand.app.service.credential.CredentialRepository
import co.algorand.app.service.credential.db.Credential
...
class ExampleCredentialProviderService : CredentialProviderService() {
    ...
    companion object {
        ...
        const val GET_PASSKEY_ACTION = "co.algorand.app.service.GET_PASSKEY"
        const val CREATE_PASSKEY_ACTION = "co.algorand.app.service.CREATE_PASSKEY"
    }

    /**
     * Handles the initialization of a create credential request operation.
     *
     * @param request The request object of type `BeginCreateCredentialRequest` containing the details required for the Create Credential operation.
     * @param cancellationSignal A signal to allow canceling the operation if needed.
     * @param callback The callback to return either the result as a `BeginCreateCredentialResponse` or an error as `CreateCredentialException`.
     */
     ...
     *
     * @param request The request object of type `BeginCreatePublicKeyCredentialRequest` containing the details required for creating the passkey.
     ...
     *
     * @param request The request object of type `BeginGetCredentialRequest` containing the details of the Get Credential operation.
     * @param cancellationSignal A signal to allow canceling the operation if needed.
     * @param callback The callback to return either the result as a `BeginGetCredentialResponse` or an error as `GetCredentialException`.
     */
     ...
     *
     * @param request The request object of type `BeginGetCredentialRequest` containing the details of the Get Credential operation.
     * @return An instance of `BeginGetCredentialResponse` that includes a list of credential entries based on the request.
     */
    ...
    private fun createNewPendingIntent(
        ...
        val intent = Intent(action).setPackage("co.algorand.app")
        if (extra != null) {
