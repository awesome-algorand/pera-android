package co.algorand.app.service.key

import android.content.Context
import android.security.keystore.KeyProperties
import android.util.Log
import co.algorand.app.service.key.db.Key
import co.algorand.app.service.key.db.KeyDatabase
import co.algorand.app.service.key.db.SecretType
...
interface KeyRepository {
    ...
    fun getDerivedParentSecret(context: Context): Key?
}
...
class Repository() : KeyRepository {
    ...
    override fun getDerivedParentSecret(context: Context): Key? {
        getDatabase(context)
